<?php
            ...
            getSourceComponents();
            var_dump($SourceAComponents);
            echo("Component end                                                              ");
            var_dump($SourceAProperties);
            //checkDataSources();
            ...
            function getSourceComponents()
            {
                ...
                try{        
                       ...
                       // echo "Component rows : ".$stmt->rowCount()."        ";
                        ...
                        while ($componentRow = $stmt->fetch(\PDO::FETCH_ASSOC)) {
                                ...
                                $SourceBComponents[$componentRow['id']] = array_merge($SourceBComponents, $values2); 
    ...
    //             foreach ($SourceAComponents as $sourceAComponent) {
    ...
    //                 foreach ($SourceBComponents as $sourceBComponent) {
    ...
    //                    $componentt['mainclass']==  $selectedComponent['MainComponentClass'] && 
    //                    $componentt['subclass']  ==  $selectedComponent['ComponentClass']){
