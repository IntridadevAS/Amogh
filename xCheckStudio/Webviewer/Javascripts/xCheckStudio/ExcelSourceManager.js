...
// get functions
ExcelSourceManager.prototype.GetCurrentTable = function () {
...
ExcelSourceManager.prototype.GetAllSourceProperties = function () {
...
ExcelSourceManager.prototype.GetAllSourcePropertiesWithValues = function () {
...
ExcelSourceManager.prototype.LoadData = function (file) {
  ...
  return new Promise((resolve) => {
    ...
    excelReader.ReadFileData(file, this.SourceType).then(function (properties) {
      ...
      // Init group view
      _this.InitGroupView(excelReader.SheetData);
...
ExcelSourceManager.prototype.RestoreData = function (classWiseComponents, selectedComponents) {
  ...
  var excelReader = new ExcelReader();
  this.SourceProperties = excelReader.RestoreSheetData(classWiseComponents, this.SourceType);
  ...
  // Init group view
  this.InitGroupView(excelReader.SheetData);

  // init data definition menu
  this.InitDataDefinitionMenu();
}

ExcelSourceManager.prototype.InitDataDefinitionMenu = function () {
  model.views[this.Id].dataDefinitionMenu = new DataDefinitionMenu(this.Id);
}

ExcelSourceManager.prototype.InitGroupView = function (sheetData) {
...
ExcelSourceManager.prototype.InitGroupViewControls = function () {
  var _this = this;
...
ExcelSourceManager.prototype.InitPropertyCallout = function () {
...
ExcelSourceManager.prototype.InitViewActionMenu = function () {
  var _this = this;
...
ExcelSourceManager.prototype.OpenTableViewsMenu = function () {
  var _this = this;
...
ExcelSourceManager.prototype.CloseTableViewsMenu = function () {
  var _this = this;
