...
$errors = array();
$uploadedFiles = array();
$extension = array("xml","XML","rvm","RVM", "xls", "XLS", "att", "ATT", "sldasm", "SLDASM","DWG", "dwg", "sldprt", "SLDPRT", "rvt", "rfa", "ifc", "IFC");
$validSources = array("xml","XML","rvm","RVM", "xls", "XLS", "sldasm", "SLDASM","DWG", "dwg", "sldprt", "SLDPRT", "rvt", "rfa", "ifc", "IFC");
// $bytes = 1024;
// $KB = 1024;
// $totalBytes = $bytes * $KB;
